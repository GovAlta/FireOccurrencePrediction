""" This is a Python program and wrapper for Dr. Mike Wotton's Lightning Fire Occurrence Prediction model.
...
class LightningOccurrencePrediction(object):
    ...
    def __init__(self,
        ...
        self.lightning_wrapper_exe_path = 'lightning\\binning\\build-ltggrids-five-period.exe'
        ...
        self.weather_binning_exe_path = 'lightning\\weather\\use_cf2.exe'

        # Build the path to the C simulation executable.
        self.simulation_exe_path =  'lightning\\simulation\\simulate-new-allyears-DC.exe'
    ...
    def lightningFirePredictionMapper(self, map_type, days_to_map, display_actuals, silently_output_maps):
        ...
        for date in days_to_map:
            ...
            if map_type == 'arrival' or map_type == 'all':
                ...
                if display_actuals:
                    actuals_gdf.plot(ax=ax, markersize=75, marker='*', color='fuchsia', label='Lightning arrival', edgecolor='black', linewidth=0.5)
    ...
    def mergeBinnedWeatherAndLightning(self):
        ...
        # Add a new column called numfire, place it as the 16th thru XXXX columns, and assign them 0 values for now.
...
def mainMethod():
    ...
    obj = LightningOccurrencePrediction(ltg_arrivals_holdovers_input_path,
                                        ltg_arrivals_holdovers_output_path,
                                        ltg_strike_raw_input_path,
                                        ltg_strike_raw_massaged_output_path,
                                        ltg_grid_locations_path,

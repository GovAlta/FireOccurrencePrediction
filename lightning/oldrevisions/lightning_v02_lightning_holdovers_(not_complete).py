    ...
    def processLightningArrivalsIgnitions(self):
        ...
        for next_row in input_csv_file:
            ...
            if int(working_dict['totltg']) > 0 and int(working_dict['pos']) >= 0:
                perpos = int(working_dict['pos']) / int(working_dict['totltg']) * 100
            ...
            if int(working_dict['totltg']) == 10:
                working_dict['totltg'] = 9
            ...
            working_dict['probign'] = '{0:.10f}'.format(probign)  # 10 decimal places
